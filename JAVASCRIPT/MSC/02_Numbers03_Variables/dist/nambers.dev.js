...
var artist = "Boulevard Depo"; //приставка let нужна только в момент объявления привязки
...
var game = "StarCraft"; //? Объявили переменную через let

console.log(game);
game = "Axie Infinity"; //? Назначили новое значение данной переменной. let уже не используем.

console.log(game); //То же самое с числами:

var sum15 = 0;
console.log(sum15);
sum15 += 1;
console.log(sum15); //Возможность перезадавать значение дает возможность создавать переменные, выполняющие роль счетчика, 
