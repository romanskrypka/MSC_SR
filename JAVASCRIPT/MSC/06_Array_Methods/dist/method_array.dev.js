...
var temperatures = [1, -3, -2, 4, 10, -5, 12, 3];
...
console.log(getAboveZero(temperatures)); //? Как это работает?
...
console.log(getSubZero(temperatures)); //! Метод find - method find
...
console.log(getLoot(bags, 420)); //! Practice - 44
...
console.log(getOddLoot(bags)); //! Map, includes, join
...
var ultrasound = [1559, "Ethereum", true, "🦇", "🔊"];
...
var strings = ["Moscow", "Coding", "School"];
